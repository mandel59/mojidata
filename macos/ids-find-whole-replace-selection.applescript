...
-- Transforms selected IDS into character candidates (comma-separated).
--
-- Recommended Automator settings:
...
on run {input, parameters}
	...
	set scriptPath to repoPath & "/macos/ids-find-whole.zsh"
	...
	if outText is "" then return input
	return outText
end run
