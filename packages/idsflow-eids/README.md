...
The package depends on `@mandel59/idsdb-utils`; no published Mojidata runtime
depends on this adapter. Run it as a separate process and
...
[MIT](LICENSE.md). The package remains private and is not published to npm.
