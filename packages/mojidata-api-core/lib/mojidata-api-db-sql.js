...
exports.createSqlApiDb = createSqlApiDb;
const idsfind_sql_1 = require("./idsfind-sql");
const idsfind_query_1 = require("./idsfind-query");
const idsfind_tokenize_1 = require("./idsfind-tokenize");
const libsearch_1 = require("./libsearch");
const mojidata_query_1 = require("./mojidata-query");
const ivsListQuery = `
  SELECT
    IVS,
...
`;
function createSqlApiDb({ getMojidataDb, getIdsfindDb, }) {
    const { search, filterChars } = (0, libsearch_1.createLibSearch)(getMojidataDb);
    const idsfind = (0, idsfind_sql_1.createIdsfind)(getIdsfindDb);
    return {
