...
exports.idsfindQuery = exports.idsfindQueryContext = void 0;
exports.makeIdsfindQuery = makeIdsfindQuery;
exports.idsfindQueryContext = `
with tokens as (
    select
        idslist.key as key0,
        ts0.key as key1,
...
`;
function makeIdsfindQuery(queryBody) {
    return `${exports.idsfindQueryContext}\n${queryBody}`;
}
exports.idsfindQuery = makeIdsfindQuery(`select UCS from results`);
