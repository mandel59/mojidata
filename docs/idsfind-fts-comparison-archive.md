# Historical FTS4/FTS5 comparison

Archived from `d945ba09` on 2026-09-17. These are the previously recorded results, not a new measurement. The original record does not identify all measurement conditions; do not use it as a matched baseline for the [September 17 report](benchmarks/2026-09-17/README.md). Commands below describe the historical document.
